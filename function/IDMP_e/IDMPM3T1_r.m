...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function R = GetOptimum(obj,N)
            temp = load('C:\Users\wjy\Desktop\PlatEMO-master\PlatEMO-master\PlatEMO\TruePFPS\IDMP-e\IDMPM3T1_r.mat', 'PSS');
            R = temp.PSS;    
        end
...
%             temp = load('D:\mycode_matlab\PlatEMO_3.5\PlatEMO\PFPS\IDMPM2T1_e_PFPS.mat', 'PSS');
            ...
            temp1 = L(:,1)>0;
            temp2 = L(:,2)>0;
            Draw(L(~temp1&~temp2,:),'.','Color',[1 .2 .2]);
            Draw(L(temp1&~temp2,:),'.','Color',[.2 .2 1]);
            Draw(L(temp1&temp2,:),'.','Color',[.2 1 .2]);
            Draw(L(~temp1&temp2,:),'.','Color',[1 1 0]);
        end
...
%             Draw(Population.objs,'o','MarkerSize',4,'Marker','o','Markerfacecolor',[1 .2 .2],'Color',[1 .2 .2]);
            ...
            temp = load('C:\Users\wjy\Desktop\PlatEMO-master\PlatEMO-master\PlatEMO\TruePFPS\IDMP-e\IDMPM3T1_r.mat', 'PF');
            L = temp.PF;
            len = size(L,1);
